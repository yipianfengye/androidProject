...
![image](http://img.blog.csdn.net/20160711155218246)
...
比如我们去掉注解Test的话：
![image](http://img.blog.csdn.net/20160711160053806)
...
```
执行之后可以发现：
![image](http://img.blog.csdn.net/20160711160510030)
...
编写完成之后，如何运行呢？
![image](http://img.blog.csdn.net/20160711160715814)

可以选中需要测试的方法名称，然后右击，弹出操作提示框，这是选择run 方法名就可以了，这时候就可以执行该测试方法了。

测试用例里面为我们提供了测试过程中可能需要的系统环境对象
![image](http://img.blog.csdn.net/20160711160833878)
...
![image](http://img.blog.csdn.net/20160711142304598)

－ 添加android tests用例
![image](http://img.blog.csdn.net/20160711142344404)

－ 配置tests方法
![image](http://img.blog.csdn.net/20160711142441553)

点击ok，这时候run区域就已经出现了我们刚刚添加的测试用例了
![image](http://img.blog.csdn.net/20160711142557158)
...
- 执行
![image](http://img.blog.csdn.net/20160711162003082)
